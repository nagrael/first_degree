 ...
 **/
public final class CamPrxHelper extends Ice.ObjectPrxHelperBase implements CamPrx
{
    private static final String __setangle_name = "setangle";

    public int setangle(int x, int y, int z)
    {
        return setangle(x, y, z, null, false);
    }

    public int setangle(int x, int y, int z, java.util.Map<String, String> __ctx)
    {
        return setangle(x, y, z, __ctx, true);
    }

    private int setangle(int x, int y, int z, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        __checkTwowayOnly(__setangle_name);
        return end_setangle(begin_setangle(x, y, z, __ctx, __explicitCtx, true, null));
    }

    public Ice.AsyncResult begin_setangle(int x, int y, int z)
    {
        return begin_setangle(x, y, z, null, false, false, null);
    }

    public Ice.AsyncResult begin_setangle(int x, int y, int z, java.util.Map<String, String> __ctx)
    {
        return begin_setangle(x, y, z, __ctx, true, false, null);
    }

    public Ice.AsyncResult begin_setangle(int x, int y, int z, Ice.Callback __cb)
    {
        return begin_setangle(x, y, z, null, false, false, __cb);
    }

    public Ice.AsyncResult begin_setangle(int x, int y, int z, java.util.Map<String, String> __ctx, Ice.Callback __cb)
    {
        return begin_setangle(x, y, z, __ctx, true, false, __cb);
    }
    ...
    {
        return begin_setangle(x, y, z, null, false, false, __responseCb, __exceptionCb, null);
    }
    ...
    {
        return begin_setangle(x, y, z, null, false, false, __responseCb, __exceptionCb, __sentCb);
    }
    ...
    public Ice.AsyncResult begin_setangle(int x, 
                                          ...
                                          IceInternal.Functional_GenericCallback1<Ice.Exception> __exceptionCb)
    {
        return begin_setangle(x, y, z, __ctx, true, false, __responseCb, __exceptionCb, null);
    }
    ...
    public Ice.AsyncResult begin_setangle(int x, 
                                          ...
                                          IceInternal.Functional_BoolCallback __sentCb)
    {
        return begin_setangle(x, y, z, __ctx, true, false, __responseCb, __exceptionCb, __sentCb);
    }

    private Ice.AsyncResult begin_setangle(int x, 
                                           int y, 
                                           int z, 
                                           java.util.Map<String, String> __ctx, 
                                           ...
                                           IceInternal.Functional_BoolCallback __sentCb)
    {
        return begin_setangle(x, y, z, __ctx, __explicitCtx, __synchronous, 
                              new IceInternal.Functional_TwowayCallbackInt(__responseCb, __exceptionCb, __sentCb)
                                  {
                                      public final void __completed(Ice.AsyncResult __result)
                                      {
                                          CamPrxHelper.__setangle_completed(this, __result);
                                      }
                                  });
    }
    ...
    {
        __checkAsyncTwowayOnly(__setangle_name);
        IceInternal.OutgoingAsync __result = getOutgoingAsync(__setangle_name, __cb);
        try
        {
            __result.prepare(__setangle_name, Ice.OperationMode.Normal, __ctx, __explicitCtx, __synchronous);
    ...
    public int end_setangle(Ice.AsyncResult __iresult)
    {
        IceInternal.OutgoingAsync __result = IceInternal.OutgoingAsync.check(__iresult, this, __setangle_name);
        try
        {
            if(!__result.__wait())
            {
    ...
    static public void __setangle_completed(Ice.TwowayCallbackInt __cb, Ice.AsyncResult __result)
    {
        lab.CamPrx __proxy = (lab.CamPrx)__result.getProxy();
        int __ret = 0;
        try
        {
            __ret = __proxy.end_setangle(__result);
        }
                             ...
                             new IceInternal.Functional_TwowayCallbackInt(__responseCb, __exceptionCb, __sentCb)
                                 {
                                     public final void __completed(Ice.AsyncResult __result)
                                     {
                                         CamPrxHelper.__stopuse_completed(this, __result);
                                     }
                                 });
    }
                         ...
                         new IceInternal.Functional_TwowayCallbackInt(__responseCb, __exceptionCb, __sentCb)
                             {
                                 public final void __completed(Ice.AsyncResult __result)
                                 {
                                     CamPrxHelper.__use_completed(this, __result);
                                 }
                             });
    }
     ...
     **/
    public static CamPrx checkedCast(Ice.ObjectPrx __obj)
    {
        return checkedCastImpl(__obj, ice_staticId(), CamPrx.class, CamPrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static CamPrx checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __ctx, ice_staticId(), CamPrx.class, CamPrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static CamPrx checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return checkedCastImpl(__obj, __facet, ice_staticId(), CamPrx.class, CamPrxHelper.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static CamPrx checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __facet, __ctx, ice_staticId(), CamPrx.class, CamPrxHelper.class);
    }
     ...
     **/
    public static CamPrx uncheckedCast(Ice.ObjectPrx __obj)
    {
        return uncheckedCastImpl(__obj, CamPrx.class, CamPrxHelper.class);
    }
     ...
     * @return A proxy for this type.
     **/
    public static CamPrx uncheckedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return uncheckedCastImpl(__obj, __facet, CamPrx.class, CamPrxHelper.class);
    }
    ...
    public static void __write(IceInternal.BasicStream __os, CamPrx v)
    {
        __os.writeProxy(v);
    }

    public static CamPrx __read(IceInternal.BasicStream __is)
    {
        Ice.ObjectPrx proxy = __is.readProxy();
        if(proxy != null)
        {
            CamPrxHelper result = new CamPrxHelper();
